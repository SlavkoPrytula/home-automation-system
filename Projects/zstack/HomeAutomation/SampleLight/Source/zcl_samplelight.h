...
#define PIN_SBIT         P1_1
#define PIN_POLARITY     ACTIVE_HIGH
#define HAL_TURN_ON_LED_1()       st( PIN_SBIT = PIN_POLARITY (1); )
#define HAL_TURN_OFF_LED_1()       st( PIN_SBIT = PIN_POLARITY (0); )

// Application Events
#define SAMPLEAPP_EVT_BLINK 			0x0001
#define SAMPLEAPP_EVT_LONG            		0x0002
...
#define SAMPLELIGHT_REPORTING_EVT            0x0008
